...
function Sec_mid() {
  return (
    <div className=' flex  w-[2000px] invert border-[1px] border-x-white border-y-black '>
      <p className='w-[40%] flex-1 m-4 place-items-center'>For you</p>
      <p className='w-[40%] flex-1 m-4  place-items-center'>Following</p>
      <p className='invert flex-end flex-none '>
